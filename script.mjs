...
// Generate and show funny/demonic email marketing view with user data
function email_view() {
  if (!currentUser) {
  ...
  <p> Sal’s Strawberry Saloon welcomes you to the orchard of damnation, where every bite drips with the blood of <em style="color:#d14775;">Thal’zor</em>. </p>
  <p> Your hunger for <strong style="color:#ff699d;">${data.FavoriteFruit}</strong> has bound you with a curse: <strong style="color:#ff699d;">${data.FruitQuantity}</strong> times each moon. <em>“Ghor’zal thun’gar, vek’al thul.”</em> </p>
<p> Your first smoothie, a gift from <strong style="color:#f06292;">Sal’zaroth</strong>, the Abyssal Blender, carries the curse of eternal decay. Sip, and you join the Seed Spirits’ endless torment. </p>
<p style="color:#c74c71; font-weight: bold;"> Changed your mind? It’s okay, these things happen. You can leave the orchard (and this email thread) anytime. No banishment, no blood pacts. Just click <a href="#" style="color:#ff8cb3; text-decoration: underline;">here</a> to opt out of your fruity fate. </p>
